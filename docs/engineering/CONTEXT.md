...
`docs/engineering/V1-BLOCK-6A-CODEX-SDK-FEASIBILITY.md` is the Codex feasibility authority. The admitted wording is `Conditional Go — Windows feasibility verified; macOS packaged runtime deferred-by-user.` Atomic R8b certification from clean pushed HEAD `834ba0b` passed 869 unit tests, 290 integration tests, packaged E2E 15/15, package verification 7/7, conditional development admission, all four lifecycle scenarios, the packaged-only SDK turn and unified verification. Certification `b6a-834ba0b6-57d262ae` binds the exact Windows artifact and seven sanitized records. Total-thread review subsequently passed Task 13.1; Task 13.2 passed supply-chain/freshness review; Tasks 13.3–13.11 and the D108–D112 safety, diagnostic, product-packaging and no-global-Git recertification decisions are implemented as recorded in `V1-BLOCK-13-STATUS.md`. Task 13.11 evidence binds product runtime HEAD `83e6e03`, compatibility fingerprint `7aa35887e5d547cbc3d21023d601b25daf08be7dc7dfebb6698827daac210d9f` and final product artifact `6d257da254a05e4bfe9170c152d0c6a2cbfe5494e35c8458b06b2f86a7d3a51b`; isolated real success, cancel and timeout sessions pass on the Windows development machine. The separately authorized Task 13.5 recertification binds clean runtime HEAD `2538722f7df36084b29500185a14eced33064386`, the same current compatibility fingerprint and artifact-content record `22fd3f7b6e1783bb4feb9830acc1f7bbc9500f44ce0c8716cf6b837c398620a5`; all 17 packaged no-global-Git assertions pass. The application auth observation remains unknown until a future explicit connection check; expired, permission-denied, rate-limit and network classifications remain unverified and have no Codex production producer. No production AI Job, SQLite persistence, checkpoint, renderer action or resumable result exists. Clean-machine, signing, Defender, proxy, enterprise certificate, firewall, offline, telemetry and macOS boundaries remain unverified or deferred. This is not full Go, cross-platform compatibility or release readiness.
