...
export const STRUCTURE_DETECTION_ERROR_RECOVERY = {
  ...
  candidate_not_found: 'user_action',
  candidate_stale: 'user_action',
  draft_already_exists: 'user_action',
  draft_not_found: 'user_action',
  draft_revision_mismatch: 'user_action',
  draft_stale: 'user_action',
  draft_validation_failed: 'user_action',
  frozen_not_found: 'user_action',
  frozen_stale: 'user_action',
  node_not_found: 'user_action',
  node_not_low_confidence: 'user_action',
  range_not_found: 'user_action',
  range_not_low_confidence: 'user_action',
  structure_reference_blocked: 'user_action',
