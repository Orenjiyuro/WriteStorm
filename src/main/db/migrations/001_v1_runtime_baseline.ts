...
export const V1_RUNTIME_BASELINE_MIGRATION = {
  ...
  semanticWitnesses: [
    ...
    },
    {
      ...
      setupSql: `INSERT INTO books (id, title, current_source_text_id, created_at, updated_at) VALUES ('book', 'Book', NULL, 'now', 'now')`,
    ...
    },
    {
      ...
      setupSql: `INSERT INTO books (id, title, current_source_text_id, created_at, updated_at) VALUES ('book', 'Book', NULL, 'now', 'now'); INSERT INTO source_texts VALUES ('source-1', 'book', 'one.txt', 1, 'txt', 'hash', 'utf8', 1, 'one.txt', 'now')`,
    ...
    },
    {
      ...
      setupSql: `INSERT INTO books (id, title, current_source_text_id, created_at, updated_at) VALUES ('book', 'Book', NULL, 'now', 'now'); INSERT INTO source_texts VALUES ('source-1', 'book', 'one.txt', 1, 'txt', 'hash-1', 'utf8', 1, 'one.txt', 'now')`,
    ...
    },
    {
      ...
      setupSql: `INSERT INTO books (id, title, current_source_text_id, created_at, updated_at) VALUES ('book-1', 'One', NULL, 'now', 'now'); INSERT INTO books (id, title, current_source_text_id, created_at, updated_at) VALUES ('book-2', 'Two', NULL, 'now', 'now'); INSERT INTO source_texts VALUES ('source', 'book-1', 'one.txt', 1, 'txt', 'hash', 'utf8', 1, 'one.txt', 'now')`,
