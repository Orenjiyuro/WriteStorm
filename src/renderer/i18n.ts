...
export const rendererText = {
  ...
  settingsUnavailable: {
    ...
    gateLabel: 'Integration gate',
    feasibilityLabel: 'Windows feasibility',
    verdictLabel: 'Overall verdict',
    platformLabel: 'Platform boundary',
    compatibilityLabel: 'SDK compatibility',
    runtimeLabel: 'Runtime authentication',
    observedAtLabel: 'Observed at',
    notObserved: 'Not observed',
    checkConnectionAction: 'Check connection',
    checkingAction: 'Checking connection…',
    connectionCheckFailed: 'Connection check could not be completed.',
    aiDisabledReason:
