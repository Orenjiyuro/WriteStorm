...
Task 20 fresh Windows evidence on 2026-07-14: `npm run check` passed with 86 unit files / 367 tests, 21 integration files / 133 tests, successful Windows x64 package, and 7/7 packaged Electron e2e tests. This does not change the blocked macOS, maker, signing or notarization rows above.
