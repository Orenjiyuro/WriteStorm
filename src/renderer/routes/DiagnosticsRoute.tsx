...
export function DiagnosticsRoute(): ReactElement {
  ...
  return (
    <main className="app-shell" aria-labelledby="diagnostics-title">
      <header className="empty-state">
        <p className="eyebrow">Diagnostics</p>
        <h1 id="diagnostics-title">Engineering contract diagnostics</h1>
      ...
      >
        ...
        <ul className="perspective-list" aria-label={perspectiveReadoutText.title}>
          {PERSPECTIVE_DEFINITIONS.map((definition) => (
            <li className="perspective-card" key={definition.key} aria-disabled="true">
          ...
          <article className="perspective-boundary-shell" aria-disabled="true">
            ...
            <dl>
              <div>
                ...
                <dd><code>{PERSPECTIVE_IDENTITY_CONTRACT.definitionKind}</code></dd>
              </div>
              <div>
                <dt>{perspectiveReadoutText.scopeMeaningLabel}</dt>
                <dd><code>{PERSPECTIVE_IDENTITY_CONTRACT.scopeRefMeaning}</code></dd>
              </div>
              <div>
            ...
            <ul>
              {PERSPECTIVE_MISSING_DEPENDENCY_FIXTURES.map((fixture) => (
                <li key={`${fixture.perspectiveKey}:${fixture.missingAssetKind}`}>
                  ...
                  <p>{perspectiveReadoutText.missingAssetLabel}: <code>{fixture.missingAssetKind}</code></p>
                </li>
              ))}
            </ul>
          </section>
      ...
      >
        <div className="readout-header">
          ...
          <span className="disabled-placeholder">{techniqueReadoutText.manualActionUnavailable}</span>
        </div>
          ...
          <article className="technique-detail-shell" aria-disabled="true">
            ...
            <dl>
              <div>
                ...
                <dd><code>{techniqueEvidencePolicy.sourceSnapshotField}</code></dd>
              </div>
              <div>
                <dt>{techniqueReadoutText.evidenceSummaryLabel}</dt>
                <dd><code>{techniqueEvidencePolicy.evidenceSummarySource}</code></dd>
              </div>
            </dl>
          </article>
        </div>
